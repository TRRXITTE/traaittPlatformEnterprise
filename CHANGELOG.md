...
- upgrades traaittplatform-wallet-backend for some transaction bugfixes
...
- bumps traaittplatform-wallet-backend version
...
- bumps traaittplatform-wallet-backend
...
- traaittplatform-wallet-backend-js version upgraded, now connects to daemon with KeepAlive = true
...
- bumps traaittplatform-wallet-backend-js dependency to latest version
...
- upgrade the traaittplatform-wallet-backend dependency to fix a bug that was caused by a batch of blocks in the ~200k range, also no longer checks for an update in development mode
